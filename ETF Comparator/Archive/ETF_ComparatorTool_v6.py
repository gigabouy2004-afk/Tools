...
INPUT_FILENAME = Path("D:/Tools/StockCodeMaster/ETF/01_INPUT_USA_Energy_ETF_Codes.csv")
OUTPUT_FILENAME = Path("D:/Tools/ETF_Comparator/OUTPUT/Theme_USA_Energy_ETF_Comparator_Results.xlsx")
