...
DEFAULT_INPUT_FILE = Path("D:/Tools/StockCodeMaster/ETF/14-06-NYSE_NASDAQ_ETF_Master_Library-Filtered.csv")
...
THEME_RULES = [
    ...
    ("Space", ["space", "astronomy", "rocket","Aerospace"]),
    ...
    ("Energy", ["energy", "oil", "gas", "natural gas", "uranium", "nuclear","hydrogen"]),
    ("Clean Energy", ["clean energy", "solar", "wind", "renewable", "battery", "lithium","nuclear"]),
