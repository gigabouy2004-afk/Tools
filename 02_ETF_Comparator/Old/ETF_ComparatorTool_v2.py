...
INPUT_FILENAME = "INPUT/01_INPUT_All_Country_ETF_Codes-tmp.csv"
OUTPUT_FILENAME = "OUTPUT/Theme_ALL_Country_ETF_Comparator_Results_v4.xlsx"
...
def compute_returns(prices: pd.Series, ref_date: pd.Timestamp):
    ...
    results["MTD"] = calc(now-month_start)
