...
def run_unified_momentum_engine(symbols, backtest_date_str, output_path):
    ...
    if df_scoring.empty:
        df_scoring = pd.DataFrame(columns=["Symbol", "Last Traded Price", "Primary_Evaluation_Window", "Last_30d_Return", "Primary_Return", "Regime_Tier", "Action_Bias", "Sharpe_Ratio", "Sortino_Ratio", "MACD_Zero_Line_Bullish"])
