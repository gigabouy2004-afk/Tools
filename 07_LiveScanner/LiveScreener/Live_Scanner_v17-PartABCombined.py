#!/usr/bin/env python3
"""
Momentum Engine V17 - Unified Pipeline (Baseline + Multi-Window + Tiered Classification)
...
returns, and three-tiered regime classifications into a structured multi-tab Excel workbook.
"""
...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="Momentum Engine V17 - Unified Pipeline (Baseline, Multi-Window & Tiered Classification)"
    )
...
# ==========================================
# 4. UNIFIED PIPELINE ENGINE
# ==========================================
def run_unified_momentum_engine(symbols, output_path):
    print(f"[*] Initializing unified baseline & multi-window ingestion for {len(symbols)} symbols...")
    ...
    for symbol in symbols:
        try:
            ...
            review_records.append({
                "Symbol": symbol,
                "Status": "Evaluated",
                "Message": "Successfully processed baseline, multi-window momentum & tiered classification"
            })
    ...
    summary_records.append({
        ...
        "engine_architecture": "V17 Unified Pipeline (Baseline + Multi-Window + Tiered)",
