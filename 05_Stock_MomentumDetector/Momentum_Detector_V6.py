...
EXECUTION_LOG_CSV = os.path.join(BASE_FOLDER, "Processed_Data","V6_Momentum_Execution_Dump.csv")
...
def main():
    parser = argparse.ArgumentParser(
        description="Momentum Detector V6",
    ...
    output_path, sorted_rows = write_execution_log(sorted_rows, args.output, force_unique=not explicit_output)
