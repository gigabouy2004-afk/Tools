...
SIGNALS_CSV = os.path.join(BASE_FOLDER, "V6_Backtest_Signal_Audit.csv")
SUMMARY_CSV = os.path.join(BASE_FOLDER, "V6_Backtest_Summary.csv")
DEFAULT_PERIOD = "8y"
...
def audit_ticker(ticker, period, signal_step_days, benchmark_df, benchmark_ticker):
...
def main():
    parser = argparse.ArgumentParser(description="Backtest Momentum Detector V6 signal quality.")
    parser.add_argument("--tickers", nargs="+", required=True)
    parser.add_argument("--period", default=DEFAULT_PERIOD)
    parser.add_argument("--signal-step-days", type=int, default=DEFAULT_SIGNAL_STEP_DAYS)
    parser.add_argument("--us-benchmark", choices=[engine.US_DEFAULT_BENCHMARK, engine.US_GROWTH_BENCHMARK], default=engine.US_DEFAULT_BENCHMARK)
    ...
    for raw_ticker in args.tickers:
        ...
        benchmark_ticker = engine.benchmark_for_ticker(ticker, us_benchmark=args.us_benchmark)
        ...
        rows = audit_ticker(ticker, args.period, args.signal_step_days, benchmark_cache[benchmark_ticker], benchmark_ticker)
    ...
    print("============================================================")
    print("=== MOMENTUM DETECTOR V6 BACKTEST COMPLETE ===")
    print("============================================================")
