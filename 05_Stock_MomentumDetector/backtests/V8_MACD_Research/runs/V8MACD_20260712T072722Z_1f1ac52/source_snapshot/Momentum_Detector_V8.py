            ...
            if df.empty:
                ...
                if benchmark_df.empty:
                    ...
                    calc_df = calculate_v5_indicators(
                        ...
                        macd_fast_period=getattr(args, "macd_fast", DEFAULT_MACD_FAST_PERIOD),
                        macd_slow_period=getattr(args, "macd_slow", DEFAULT_MACD_SLOW_PERIOD),
                        macd_signal_period=getattr(args, "macd_signal", DEFAULT_MACD_SIGNAL_PERIOD),
                    )
...
def main():
    ...
    parser.add_argument("--macd-fast", type=int, default=DEFAULT_MACD_FAST_PERIOD,
                        help="MACD fast EMA period; informational in V8 until a MACD policy is approved.")
    parser.add_argument("--macd-slow", type=int, default=DEFAULT_MACD_SLOW_PERIOD,
                        help="MACD slow EMA period; informational in V8 until a MACD policy is approved.")
    parser.add_argument("--macd-signal", type=int, default=DEFAULT_MACD_SIGNAL_PERIOD,
                        help="MACD signal EMA period; informational in V8 until a MACD policy is approved.")
