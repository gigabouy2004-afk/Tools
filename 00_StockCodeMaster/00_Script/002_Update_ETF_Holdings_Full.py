...
# Set your fully qualified input NASDAQ/ETF master CSV file path here:
NASDAQ_ETF_MASTER_FILE = Path(r"D:\TMP\1-8-2026\XX-US_ETF_Master_Library.csv")
# Set your fully qualified output ETF holdings file path here:
...
def process_nasdaq_etf_holdings():
    print("\n================================================================================")
    print("RUNNING NASDAQ ETF HOLDINGS GENERATION ENGINE")
    print("================================================================================")
    ...
    for idx, etf_ticker in enumerate(etf_tickers, start=1):
        ...
        if name_col:
            ...
            if not match_row.empty:
                etf_name = str(match_row.iloc[0][name_col])

        print(f"  - Processing ETF {idx}/{total_etfs}: {etf_ticker_str}")
