...
ETF_CATEGORY_PATTERNS = [
    ...
    ("Solana", re.compile(r"\bsolana\b", re.IGNORECASE)),
    ("Dogecoin", re.compile(r"\bdogecoin\b", re.IGNORECASE)),
    ("Stagecoin", re.compile(r"\bstagecoin\b", re.IGNORECASE)),
    ("SUI", re.compile(r"\bsui\b", re.IGNORECASE)),
    ("Crypto", re.compile(r"\bcrypto\b", re.IGNORECASE)),
    ("Hyperliquid", re.compile(r"\bhyperliquid\b", re.IGNORECASE)),
    ("Polkadot", re.compile(r"\bpolkadot\b", re.IGNORECASE)),
    ("Canton", re.compile(r"\bcanton\b", re.IGNORECASE)),
    ("iBonds", re.compile(r"\bibonds\b", re.IGNORECASE)),
    ("YieldBOOST", re.compile(r"\byieldboost\b", re.IGNORECASE)),
    ("Autocallable", re.compile(r"\bautocallable\b", re.IGNORECASE)),
    ("Grayscale", re.compile(r"\bgrayscale\b", re.IGNORECASE)),
