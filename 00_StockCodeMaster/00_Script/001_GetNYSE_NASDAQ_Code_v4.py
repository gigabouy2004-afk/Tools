...
# RESOLVED: Combined into a single pattern and removed invalid dangling quantifiers (*)
EXOTIC_ETF_NOT_BLOCK = re.compile(
    r"leverag|ultra|short|inverse|bear|bull|bitcoin|btc\b|eth\b|ether|crypto|etn\b|income|option|proshare|yieldmax|"
    r"2X|3X|21Shares|coin|crypto|blockchain|bitcoin|ethereum|ether|btc|eth|sui|solana|defi|metaverse|nft",
    re.IGNORECASE
)
...
def execute_elimination_and_classification(master_df, default_geography):
    ...
    # Sort and Split Stock Registry into Geographical Artifacts
    ...
    # Split ETF Registry and Classification Maps into Geographical Artifacts
...
def main():
    ...
    print("================================================================================")
    print(f"  [GLOBAL RAW CACHE HISTORIES]")
